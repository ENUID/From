export const metadata = { title: 'Terms of Service — FROM' }
...
export default function TermsPage() {
  return (
    <main style={{ maxWidth: 680, margin: '0 auto', padding: '60px 24px 80px', fontFamily: "'DM Sans', system-ui, sans-serif", color: '#2C1206', lineHeight: 1.7 }}>
      ...
      <p>You must be 16 or older to use FROM. You are responsible for keeping your account credentials secure. FROM accounts are personal and non-transferable.</p>

      <h2 style={{ fontSize: 16, fontWeight: 600, marginTop: 32, marginBottom: 8 }}>3. What FROM does</h2>
      ...
      <p>All FROM UI, AI systems, and brand content are the property of their respective owners. Product images and descriptions belong to the originating stores.</p>

      <h2 style={{ fontSize: 16, fontWeight: 600, marginTop: 32, marginBottom: 8 }}>7. Limitation of liability</h2>
      <p>FROM is provided as-is. To the maximum extent permitted by law, FROM is not liable for any indirect, incidental, or consequential damages arising from your use of the service.</p>

      <h2 style={{ fontSize: 16, fontWeight: 600, marginTop: 32, marginBottom: 8 }}>8. Changes</h2>
      <p>We may update these terms from time to time. Continued use of FROM after changes are posted means you accept the revised terms.</p>
