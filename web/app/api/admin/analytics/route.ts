...
export async function GET(req: NextRequest) {
  ...
  const [overview, timeSeries, topSearches, topUsers, activity, topProducts, insight, aiUsage] = await Promise.all([
    ...
    run('insight', convex.query(anyApi.learningInsights.getLatest, { adminSecret })),
    serverSecret
  ...
  return NextResponse.json({ ok: true, days, overview, timeSeries, topSearches, topUsers, activity, topProducts, insight, aiUsage, diag, hint })
}
